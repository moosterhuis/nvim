...
local config = {
  ...
  settings = {
    java = {
      ...
      home = '/home/moosterhuis/.sdkman/candidates/java/current/bin/java',
      eclipse = {
      ...
      configuration = {
        ...
        runtimes = {
          {
            name = "JavaSE-17",
            path = "/home/moosterhuis/.sdkman/candidates/java/17.0.11-tem",
          },
          {
            name = "JavaSE-21",
            path = "/home/moosterhuis/.sdkman/candidates/java/21.0.4-tem",
          }
        }
      },
      maven = {
